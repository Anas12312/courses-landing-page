...
export default function StudyPlans({ ref }) {
    return (
        <div ref={ref} className='w-full relative h-[34rem] bg-white flex flex-col justify-start items-center pb-8 text-black'>
            ...
            <div className='grid grid-cols-4 gap-4 w-8/12 h-full py-10 mt-20'>

                <div className='relative w-full h-4/5 bg-[#F5F5F5] rounded-xl flex justify-center items-end hover:bg-[#aaaaaa] hover:transition'>
